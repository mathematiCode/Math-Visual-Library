mathVisual.fractionMultiplicationAreaModel = (
  ...
  if (factor1.numerator == 0 && factor1.denominator == 0) {
    factor1.denominator = 1;
  }
  if (factor2.numerator == 0 && factor2.denominator == 0) {
    factor2.denominator = 1;
  }
  ...
  if (factor1.numerator != 0 && factor1.numerator == factor1.denominator) {
    factor1.wholeNum += 1;
    factor1.numerator = 0;
  }
  if (factor2.numerator != 0 && factor2.numerator == factor2.denominator) {
    factor2.wholeNum += 1;
    factor2.numerator = 0;
  }
...
mathVisual.fractionMultiplicationGroupModel = (
  ...
  if (
    ...
    (factor1.denominator === 0 && factor1.numerator !== 0) ||
    factor2.wholeNum === 0
  ) {
    return;
